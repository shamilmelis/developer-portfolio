                    ...
                    <div className={'skills_container'}>
                        <div className={'skills_box'}>
                                    ...
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                ...
                                                программного кода на различных языках программирования (Groovy, Erlang,
                                    ...
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                ...
                                                программирования. Он относительно немного весит, гибкий и удобный. В нем
                                                можно писать, форматировать и редактировать код на разных языках.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className={'col'}>
                            ...
                            <div className={'skills_inner_box'}>
                                    ...
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                ...
                                                мобильных приложений. Часто в текстах и обучающих материалах название
                                    ...
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                ...
                                                странице. Код на HTML говорит браузеру о том, как необходимо отобразить
                                                информацию. Для разметки используются теги, которые помогают добавлять
                                                заголовки, параграфы, списки, ссылки, изображения, видео и таблицы.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className={'col'}>
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                ...
                                                HTML-документа, работать со шрифтами, цветами, градиентами и анимациями.
                                ...
                                <div className={blocks === false ? 'col col-hide' : 'col col-show'}>
                                    <div className={'box'}>
                                        <img
                                        ...
                                        <div className={'rotate_box_info'}>
                                            <span>Sass</span>
                                            <p>
                                                Sass — это метаязык (язык для описания другого языка), который упрощает
                                    ...
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                ...
                                                открытым исходным кодом для разработки пользовательских интерфейсов. Она
                                ...
                                <div className={blocks === false ? 'col col-hide' : 'col col-show'}>
                                    <div className={'box'}>
                                        ...
                                        <div className={'rotate_box_info'}>
                                            ...
                                            <p>
                                                Material-UI – это крупная библиотека, посредством которой разработчики
